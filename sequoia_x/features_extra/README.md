...
| finance | fin_roe/gp_margin/np_margin/debt_ratio/rev_yoy/profit_yoy/chg/cf_quality/eps/bps/roe_tb/rev_yoy_chg/current_ratio/quick_ratio/inv_turn_days/ar_turn_days | **16** | 报告期→法定披露日(Q1:4/30 H1:8/31 Q3:10/31 年报:次年4/30) asof（2026-08-20 从 10 扩到 16） |
...
| **dragon_tiger** | dt_net_buy(亿)/dt_net_rate/dt_cnt_30d | **3** | 龙虎榜日榜，事件日 asof（2026-08-20 新增，近一年） |
| **limit_up** | lu_lianban/lu_seal(亿)/lu_cnt_30d | **3** | 涨停日榜，事件日 asof（2026-08-20 新增，近一年） |
| **合计** | | **41** | （forecast 已于 2026-08-20 移除，88+41=129维 feature_version=4） |
...
- 语义可缺失面 consensus(46%无研报)/dragon_tiger/limit_up(非上榜股无事件)/news/xdxr(次新无分红): 缺失不影响（forecast 2026-08-20 移除）
