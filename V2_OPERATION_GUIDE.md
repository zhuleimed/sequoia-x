...
- **V4（129 维）对比（2026-08-21 实测，summary_all.csv 08-20）**：70 月同口径下 M4_TOP10 旧 121维(+944.8%/52.1%/2.28) vs **V4 129维(+2103%/年化~70%/3.06)**——**显著提升**（终值 22× vs 10.4×，回撤 -13.4% vs -18.2%）。最优 M4_15：年化 ~68.7%/夏普 3.22。
  - ⚠️ **绝对年化（~70%）偏高，属 super-alpha 水平，需独立复核**（V4 无月度明细可抽查；回测引擎对暴涨股敏感易含幸存者偏差，不宜直接当实盘预期）。
