...
- **最终结果**（70 个月回测，2020-09~2026-06，2026-08-21 修正口径）：T2+T4 融合、M4 风控、TOP_N=10 → **总收益 +944.8%、年化 52.1%、夏普 2.28、回撤 -18.2%、胜率 70%**（见 BACKTEST_PLAN §27.2）。
  - ⚠️ **口径修正**：早年文档的"年化 89.5%、夏普 3.35"是 **11 个月**回测的总收益/夏普（BACKTEST_PLAN §"最终最佳配置"），被误记为"70 个月年化"。权威 70 个月结果为 52.1%/2.28。
